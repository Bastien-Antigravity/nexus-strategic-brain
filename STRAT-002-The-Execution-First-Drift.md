...
*   **The Gap**: `business-bdd-brain/02-Behavior-Specs/data-ingestor/` remains empty (The "What").
...
This drift violates the **[[nexus-strategic-brain/Strategic-Patterns#Spec-First Enforcement|Spec-First Enforcement Law]]**: 
...
2.  **Contract Definition**: Generate `business-bdd-brain/02-Behavior-Specs/data-ingestor/FEAT-001-Orderbook-Ingestion.md`.
